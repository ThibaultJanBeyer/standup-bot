...
import { LineAnimationTop } from "../components/LineAnimations";
...
export const SectionInstall = ({
  ...
  return (
    <>
      <LineAnimationTop />
      <section
        className={`relative grid grid-cols-2 items-end gap-24 ${className}`}
        {...props}
      >
        <div>
          ...
          <p className="mb-10 text-lg">
            Make Stand-ups simple and automated. With your own bot, making it
            easy to catch up with projects.
          </p>
        ...
        <div className="relative">
          <Image
            src={RoboHand}
            alt=""
            className="absolute bottom-[-180px] left-[100px] min-w-[300px] max-w-[450px]"
          />
        </div>
      </section>
    </>
